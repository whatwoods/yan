...
export const ICONS = {
  ...
  chip:    (p) => <Icon {...p}><rect x="6" y="6" width="12" height="12" rx="2"/><path d="M9 3v3M15 3v3M9 18v3M15 18v3M3 9h3M3 15h3M18 9h3M18 15h3"/><rect x="9" y="9" width="6" height="6" rx="1"/></Icon>,
  square:  (p) => <Icon {...p} fill="currentColor" sw={0}><rect x="6" y="6" width="12" height="12" rx="2"/></Icon>,
  grid:    (p) => <Icon {...p}><rect x="3" y="3" width="8" height="8" rx="1.5"/><rect x="13" y="3" width="8" height="8" rx="1.5"/><rect x="3" y="13" width="8" height="8" rx="1.5"/><rect x="13" y="13" width="8" height="8" rx="1.5"/></Icon>,
};
